...
fn validate_abac_status(value: &Value) -> Result<(), String> {
    validate_namespaced_enum(value, "AbacStatus", "aws.s3_bucket", VALID_ABAC_STATUS).map_err(
        |reason| {
...
fn validate_access_tier(value: &Value) -> Result<(), String> {
    validate_namespaced_enum(value, "AccessTier", "aws.s3_bucket", VALID_ACCESS_TIER).map_err(
        |reason| {
            if let Value::String(s) = value {
...
fn validate_expiration(value: &Value) -> Result<(), String> {
    validate_namespaced_enum(value, "Expiration", "aws.s3_bucket", VALID_EXPIRATION).map_err(
        |reason| {
            if let Value::String(s) = value {
...
fn validate_format(value: &Value) -> Result<(), String> {
    validate_namespaced_enum(value, "Format", "aws.s3_bucket", VALID_FORMAT).map_err(|reason| {
        if let Value::String(s) = value {
...
fn validate_mode(value: &Value) -> Result<(), String> {
    validate_namespaced_enum(value, "Mode", "aws.s3_bucket", VALID_MODE).map_err(|reason| {
        if let Value::String(s) = value {
...
fn validate_protocol(value: &Value) -> Result<(), String> {
    validate_namespaced_enum(value, "Protocol", "aws.s3_bucket", VALID_PROTOCOL).map_err(|reason| {
        if let Value::String(s) = value {
...
fn validate_sse_algorithm(value: &Value) -> Result<(), String> {
    validate_namespaced_enum(value, "SseAlgorithm", "aws.s3_bucket", VALID_SSE_ALGORITHM).map_err(
        |reason| {
            if let Value::String(s) = value {
...
fn validate_status(value: &Value) -> Result<(), String> {
    validate_namespaced_enum(value, "Status", "aws.s3_bucket", VALID_STATUS).map_err(|reason| {
        if let Value::String(s) = value {
...
fn validate_storage_class(value: &Value) -> Result<(), String> {
    validate_namespaced_enum(value, "StorageClass", "aws.s3_bucket", VALID_STORAGE_CLASS).map_err(
        |reason| {
            if let Value::String(s) = value {
