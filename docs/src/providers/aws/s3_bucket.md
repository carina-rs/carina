...
|-------|----------------|
| `Enabled` | `aws.s3_bucket.AbacStatus.Enabled` |
| `Disabled` | `aws.s3_bucket.AbacStatus.Disabled` |
...
| Value | DSL Identifier |
|-------|----------------|
| `AuthenticatedRead` | `aws.s3_bucket.AccessControl.AuthenticatedRead` |
| `AwsExecRead` | `aws.s3_bucket.AccessControl.AwsExecRead` |
| `BucketOwnerFullControl` | `aws.s3_bucket.AccessControl.BucketOwnerFullControl` |
| `BucketOwnerRead` | `aws.s3_bucket.AccessControl.BucketOwnerRead` |
| `LogDeliveryWrite` | `aws.s3_bucket.AccessControl.LogDeliveryWrite` |
| `Private` | `aws.s3_bucket.AccessControl.Private` |
| `PublicRead` | `aws.s3_bucket.AccessControl.PublicRead` |
| `PublicReadWrite` | `aws.s3_bucket.AccessControl.PublicReadWrite` |
