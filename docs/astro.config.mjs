          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                { label: 'destroy', link: '/reference/cli/destroy/' },
                { label: 'fmt', link: '/reference/cli/fmt/' },
                { label: 'lint', link: '/reference/cli/lint/' },
                { label: 'export', link: '/reference/cli/export/' },
                { label: 'state', link: '/reference/cli/state/' },
                { label: 'force-unlock', link: '/reference/cli/force-unlock/' },
                { label: 'module info', link: '/reference/cli/module-info/' },
                { label: 'completions', link: '/reference/cli/completions/' },
                { label: 'docs', link: '/reference/cli/docs/' },
                { label: 'skills', link: '/reference/cli/skills/' },
              ],
            },
          ],
        },
