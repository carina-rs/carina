...
mod tests {
    ...
    // TODO: Add test for Replace dependency ordering once the real environment
    // failure is diagnosed. The previous test passed both with and without the fix,
    // so it wasn't actually verifying the behavior. See #980.
}
